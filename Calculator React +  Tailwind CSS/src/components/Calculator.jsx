...
const Calculator = () => {
  ...
  function handleButton(value) {
    ...
    } else if (value === "EQUAL") calculateResult();
  ...
  const operationClass =
    "text-[1.2rem] tracking-[2px] flex gap-[5px] items-center font-bold justify-end";
  const resultClass = "text-[1.7rem]";

  return (
    <div className="min-w-[320px] bg-[white] flex flex-col gap-4 p-4 rounded-2xl">
      <div className="overflow-x-auto bg-[#72addd] shadow-lg shadow-teal-200 min-h-[100px] flex items-end justify-end flex-col p-4 rounded-[10px]">
